...
class NewNewAppointmentScreen extends StatefulWidget {
  const NewNewAppointmentScreen({super.key});

  @override
  _NewNewAppointmentScreenState createState() => _NewNewAppointmentScreenState();
}

class _NewNewAppointmentScreenState extends State<NewNewAppointmentScreen> {
  ...
  void _fetchAppointments() async {
    ...
    try {
      ...
      print('Error fetching appointments 2: $e');
    }
