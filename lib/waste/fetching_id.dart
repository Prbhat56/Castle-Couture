...
//       print("ujdcjupdatedtime$updatedtime");

//       print("bjhhbjdcbhjdbsaelectedtime$selectedDateTime");
...
//       bool stylistIdFound = false; // Flag to track whether stylist ID is found
...
//       DateTime endDateTime = updatedDateTime;
//       String formattedEndTime = DateFormat('hh:mma').format(endDateTime);
...
//           if (isavailable) {
//             DateTime updatedDateTime = DateFormat('hh:mma').parse(updatedtime);
//             int durationInMilliseconds = currentduration ?? 0;
//             DateTime endDateTime = updatedDateTime
...
//         print("hdshghjhtime$appointmentForThatSpecificTime");
...
//                   .toList();
//           if (appointmentwithspecifictimeandstlistids.isEmpty) {
//             isalltimefill = false;
//             break;
//           }
//         }
...
//         // if (appointmentwithspecifictimeandstlistids.length >= _stylistIds.length ) {
//         //   availableTimes.removeAt(timeIndex);
//         //   timeIndex = timeIndex - 1;
//         //   continue;
//         // }
...
//     if (_fetchingTime) {
//       // Exit the function if fetching time is in progress
//       setState(() {
...
//     // Save selected date as a string in SharedPreferences
...
//         _selectedDate!,
//         finalAvailableTimes[
//             _selectIndex]); // Wait for newtypeofstylishids to complete
//     print(_selectedDate);
//     print(_selectIndex);

//     if (showblockerror) {
//       // Reset showblockerror and fetch available times again
//       setState(() {
//         showblockerror = false;
//       });
//       await fetchfinallistoftime(_selectedDate!);
//       setState(() {
//         _fetchingTime = false; // Reset the fetching time flag
//       });
//       return;
//     }

//     if (_selectedDate != null && _selectIndex != -1 && !showblockerror) {
...
//         DateFormat("yyyy-MM-ddTHH:mm:ss.SSS'Z'").format(kolkataDate);
...
//                                     crossAxisSpacing: 15,
//                                   ),
//                                   itemCount: finalAvailableTimes.length,
